"""
DOGEStrategy — selective strategy for DOGE 15-min binaries.

Design philosophy: DOGE is hostile to pure TA. The strategy is conservative
by construction — aggressive skip rules, higher Min EV. Low trade frequency
is expected.
...
class DOGEStrategy(BaseStrategy):
    ...
    def decide(self, features: MarketFeatures, macro_event_active: bool = False) -> Decision:
        ...
        return self._decide_after_skip(features, idio_signals)
