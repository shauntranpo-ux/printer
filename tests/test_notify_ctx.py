...
def test_notify_ctx_15m():
    got = _MOD._notify_ctx("ETH", "KXETH15M-26APR231715-3500")
    assert got == "[ETH | 15m | KXETH15M-26APR231715-3500]"


def test_notify_ctx_btc_15m():
    got = _MOD._notify_ctx("BTC", "KXBTC15M-26APR231715-95000")
    assert got == "[BTC | 15m | KXBTC15M-26APR231715-95000]"
