...
from strategies.original.doge_strategy import DOGEStrategy
...
@patch("strategies.original.doge_strategy.current_session", return_value="weekend")
...
@patch("strategies.original.doge_strategy.current_session", return_value="normal")
...
@patch("strategies.original.doge_strategy.is_weekend_retail_fomo", return_value=True)
@patch("strategies.original.doge_strategy.current_session", return_value="weekend")
...
@patch("strategies.original.doge_strategy.is_weekend_retail_fomo", return_value=False)
@patch("strategies.original.doge_strategy.current_session", return_value="weekend")
...
def test_is_weekend_retail_window_boundaries():
    from strategies.original.signals.session_awareness import is_weekend_retail_window
...
def test_is_weekend_retail_fomo_requires_all_gates():
    from strategies.original.signals.session_awareness import is_weekend_retail_fomo
    from datetime import datetime, timezone
