...
from strategies.original.sol_strategy import SOLStrategy
from strategies.features import MarketFeatures
from strategies.skip_layer import SkipConfig
import strategies.original.signals.solana_health as sh_module
...
@patch("strategies.original.sol_strategy.check_solana_health", return_value=(True, "ok"))
...
@patch("strategies.original.sol_strategy.check_solana_health",
